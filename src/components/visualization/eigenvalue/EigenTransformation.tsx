...
export default function EigenTransformation({}: SimulationComponentProps) {
  ...
  return (
    <SimulationPanel title="Eigenvalue Transformation" caption="Eigenvectors (colored lines) stay on their span during transformation — they only scale by their eigenvalue.">
      <SimulationSettings>
        <div className="flex gap-4 items-center flex-wrap">
          ...
          <input
            ...
            className="w-16 px-2 py-1 bg-[var(--surface-1)] rounded text-[var(--text-strong)] text-center"
          />
          <SimulationButton variant="secondary" onClick={() => setMatrix([[2, 1], [0, 3]])}>Reset</SimulationButton>
        </div>
      </SimulationSettings>
      <SimulationMain>
