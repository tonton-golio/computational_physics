...
export default function AcceptReject({}: SimulationComponentProps) {
  ...
  return (
    <SimulationPanel title="Accept-Reject Sampling">
      <SimulationConfig>
        <div>
          <SimulationLabel>Number of accepted samples: {numSamples}</SimulationLabel>
