...
const NonlinearEquationsPage: React.FC = () => {
  ...
  const generatePhaseData = () => {
    if (system === 'lotka') {
      ...
      return {
        data: [] as Data[],
        layout: { title: { text: 'Logistic: 1D System - See Time Series' } } as Partial<Layout>
      };
    }
  };
  ...
  const generateTimeData = () => {
    ...
    return {
      ...
      layout: {
        ...
        yaxis: { title: { text: 'x' } },
        ...(system === 'lotka' ? {
          yaxis2: { title: { text: 'y' }, side: 'right', overlaying: 'y' }
        } : {}),
        width: 600, height: 500
      } as Partial<Layout>
    };
  ...
  const generateBifurcationData = () => {
    if (system === 'logistic') {
      ...
      return {
        ...
        layout: {
          title: { text: 'Bifurcation Diagram: r vs Fixed Points' },
          xaxis: { title: { text: 'r' } },
          yaxis: { title: { text: 'x*' } },
          width: 600, height: 500
        } as Partial<Layout>
